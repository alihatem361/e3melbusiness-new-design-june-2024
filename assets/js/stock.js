(function () {
  ...
  // Sample stock data (replace with actual data)
  const stockData = [
    { x: "2023-10-01", close: 150 },
    { x: "2023-10-02", close: 154 },
    { x: "2023-10-03", close: 156 },
    { x: "2023-10-04", close: 159 },
    { x: "2023-10-05", close: 160 },
    { x: "2023-10-06", close: 163 },
    { x: "2023-10-07", close: 158 },
    { x: "2023-10-08", close: 162 },
  ];

  const stockLineChart = new Chart(ctx, {
    type: "line",
    data: {
      datasets: [
        {
